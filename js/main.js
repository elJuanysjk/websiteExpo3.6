            ...
            submitHandler: function(form) {
                ...
                $.ajax({
                    ...
                    error: function() {
                        ...
                        sLoader.slideUp("slow"); 
                        $('.message-warning').html("UPS hubo un error. Por favor vuelve a intentarlo.");
                        $('.message-warning').slideDown("slow");
    ...
    * ------------------------------------------------------ */
    var clAjaxChimp = function() {
        ...
        $.ajaxChimp.translations.es = {
            'submit': 'Submitting...',
            0: '<i class="fa fa-check"></i> Enviamos un correo de confirmación',
            1: '<i class="fa fa-warning"></i> Debe ingresar un correo electrónico válido.',
